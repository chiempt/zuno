...
ActiveRecord::Schema[7.1].define(version: 2025_09_29_000004) do
  ...
  create_table "channel_zalo_personal", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_channel_zalo_personal_on_name"
    t.index ["proxy"], name: "index_channel_zalo_personal_on_proxy"
  end
  ...
  add_foreign_key "channel_zalo_personal", "accounts"
